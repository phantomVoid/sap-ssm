...
@Component("ProjectPackFeedIntfJob")
public class ProjectPackFeedIntfJob extends SapCommIntfImpl {
    ...
    public void execute() {
        ...
        System.out.println("3: >>> Quartz的任务调度-包装单投料接口[ProjectPackFeedIntfJob]" + format.format(new Date()));
