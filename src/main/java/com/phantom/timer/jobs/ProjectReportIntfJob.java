...
import com.phantom.wss.impl.ProjectReportIntfImpl;
import com.phantom.wss.quartz.QuartzProjectReportIntf;
import com.phantom.wss.quartz.impl.QuartzProjectReportIntfImpl;
...
@Component("ProjectReportIntfJob")
public class ProjectReportIntfJob extends SapCommIntfImpl {
    ...
    public void execute() {
        ...
        System.out.println("5: >>> Quartz的任务调度-工单报工接口[ProjectReportIntfJob]" + format.format(new Date()));
