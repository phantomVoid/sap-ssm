 ...
 * @author 
 */
public class TQuartzLog implements Serializable {
    private String ID;
    ...
    public boolean equals(Object that) {
        ...
        TQuartzLog other = (TQuartzLog) that;
        return (this.getID() == null ? other.getID() == null : this.getID().equals(other.getID()))
            ...
            && (this.getLOG_INFO() == null ? other.getLOG_INFO() == null : this.getLOG_INFO().equals(other.getLOG_INFO()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLOG_INFO() == null) ? 0 : getLOG_INFO().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", LOG_INFO=").append(LOG_INFO);
