...
import com.phantom.wss.quartz.QuartzProjectPostPackIntf;
 ...
 **/
@Component
public class QuartzProjectPostPackIntfImpl extends SapCommIntfImpl implements QuartzProjectPostPackIntf {
    ...
    public String quartzExec() {
        ...
        try {
            ...
            for (TPmProjectPost projectPost : projectPostList) {
                ...
                quartzLog.setPROJECT_ID(projectPost.getPROJECT_ID());
