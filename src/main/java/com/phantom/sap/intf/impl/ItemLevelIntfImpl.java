...
import com.phantom.sap.intf.ItemLevelIntf;
 ...
 **/
@Component
@WebService(endpointInterface = "com.phantom.sap.intf.ItemLevelIntf", serviceName = "ItemLevelIntf", targetNamespace = "http://cxf.temptation.cn/")
public class ItemLevelIntfImpl extends SapCommIntfImpl implements ItemLevelIntf {
    ...
    public Boolean levelCodeNotExist(String code) {
        ...
        criteria.andLEVEL_CODEEqualTo(StringUtils.formatZero(code));
